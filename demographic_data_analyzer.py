...
def calculate_demographic_data(print_data=True):
    ...
    higher_education_rich = (higher_education[higher_education['salary'] == '>50K'].count() / higher_education.shape[0] * 100).max().round(1)
    lower_education_rich = (lower_education[lower_education['salary'] == '>50K'].count() / lower_education.shape[0] * 100).max().round(1)
